        ...
        <div class="border-gray-200 dark:border-gray-700">
            <nav class="-mb-px flex space-x-8">
                <button onclick="switchTab('matrix')" id="tab-matrix"
                    class="tab-button active whitespace-nowrap py-2 px-3 border-b-2 font-medium text-sm transition-colors duration-200 border-primary-500 text-primary-600 dark:text-primary-400 border rounded-lg">
                ...
                <button onclick="switchTab('preference')" id="tab-preference"
                    class="tab-button whitespace-nowrap py-2 px-3 border-b-2 font-medium text-sm transition-colors duration-200 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300 border rounded-lg">
                    <div class="flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button onclick="switchTab('net-flow')" id="tab-net-flow"
                    class="tab-button whitespace-nowrap py-2 px-3 border-b-2 font-medium text-sm transition-colors duration-200 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300 border rounded-lg">
                    <div class="flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                        <span class="inline-block min-w-[70px]">
                                            {{ number_format($preferenceMatrix[$altA->id][$altB->id] ?? 0, 2) }}
                                        </span>
                                    </td>
                                    @endforeach
                                </tr>
